        ...
        <div className="flex gap-5">
          ...
          <div className="flex flex-col">
            ...
            <div>
              ...
              Cinematic Emotions! 😍🎉 Welcome to my movie realm! 🎉 As a
              devoted film enthusiast, I express my cinematic experiences
              through captivating emojee reviews! 📝💖 From heartwarming to
      ...
      <Container>
        <div>
          ...
          <div className="flex gap-3">
            <div className="w-1/3 h-48 md:h-[22rem] lg:h-96 bg-slate-300 rounded-md flex justify-center group hover:drop-shadow-xl ease-in duration-150 cursor-pointer">
